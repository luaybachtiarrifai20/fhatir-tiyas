    ...
    >
      ...
      >
        ...
        <div className="w-full grid grid-cols-2 gap-2">
          ...
          <div className="rounded-[14px] overflow-hidden">
            <img src={photos[4]} alt="Gallery 5" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="rounded-[14px] overflow-hidden">
            <img src={photos[5]} alt="Gallery 6" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="rounded-[14px] overflow-hidden">
            <img src={photos[6]} alt="Gallery 7" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="rounded-[14px] overflow-hidden">
            <img src={photos[7]} alt="Gallery 8" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="rounded-[14px] overflow-hidden">
            <img src={photos[8]} alt="Gallery 9" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
          </div>
        </div>
      </div>
    </section>
