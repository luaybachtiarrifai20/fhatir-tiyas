...
const EventCard: React.FC<{
  ...
  >
    <h2
      className="text-[#F8BB63] text-[25px] font-normal mb-3"
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center px-5 pt-10 pb-12 gap-6">
        ...
        />
        <EventCard
          title={weddingConfig.acara.resepsi.title}
          date={weddingConfig.acara.resepsi.date}
          time={weddingConfig.acara.resepsi.time}
          location={weddingConfig.acara.resepsi.location}
          mapsUrl={weddingConfig.acara.resepsi.mapsUrl}
        />
      </div>
    </section>
  );
